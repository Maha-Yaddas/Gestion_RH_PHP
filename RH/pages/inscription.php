...
<meta name="theme-color" content="#7952b3">
  ...
  <body style="background: linear-gradient(to bottom right, #8AAAF2, black); background-repeat: no-repeat;height: 761px">
    <?php include('menu.php');?>
    
    <h1 style="color: black; margin-left: 40px;">Inscrivez-vous</h1>
    <br> 
    
    <div class="container">
    <img src="../images/undraw_profile_pic_ic5t.svg" style="margin-left: 600px;">
  ...
  <div class="inscform">
    ...
    <div class="row">
    <div class="form-group col-6">
    <input type="submit" class="btn btn-primary" id="inscrire" name="submit" value="S'inscrire">
    </div>    
    </div>    
     </form> 
