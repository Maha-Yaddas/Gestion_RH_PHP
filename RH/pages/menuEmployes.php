...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
  <div class="container-fluid"> <!--fluid c-a-d s'adapte à la taille d'écran-->
      <a class="navbar-brand" href="#">DJ<span style="color:yellow">RH</span></a><!--brand pour la mise en forme-->
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <form class="d-flex">
        <a class="btn btn-outline-warning" style="border-radius: 25px;" href="deconnecter.php">Se déconnecter</a>
      </form>
    </div>
  </div>
</nav>
